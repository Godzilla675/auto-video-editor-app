...
def main() -> None:
    ...
    parser.add_argument("--intro", help="Path to intro video file", default=None)
    parser.add_argument("--outro", help="Path to outro video file", default=None)

    # Subtitle styling arguments
    parser.add_argument("--font", help="Font for captions", default="Arial")
    parser.add_argument("--fontsize", help="Font size for captions", type=int, default=40)
    parser.add_argument("--fontcolor", help="Font color for captions", default="white")
    parser.add_argument("--stroke-color", help="Stroke color for captions", default="black")
    parser.add_argument("--stroke-width", help="Stroke width for captions", type=float, default=1.5)
