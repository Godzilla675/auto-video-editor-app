...
def main() -> None:
    ...
    parser.add_argument("--intro-text", help="Text to display in the intro", default=None)
    parser.add_argument("--outro-text", help="Text to display in the outro", default=None)
