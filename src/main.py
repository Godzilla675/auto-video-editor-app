...
def main() -> None:
    ...
    parser.add_argument("--filter", help="Visual filter to apply (black_white, invert_colors, painting, rotate, mirror_x, mirror_y)", default=None)
    parser.add_argument("--intro-text", help="Text for intro title card", default=None)
    parser.add_argument("--outro-text", help="Text for outro title card", default=None)
    ...
    parser.add_argument("--subtitle-box-color", help="Subtitle background box color", default=None)
    parser.add_argument("--subtitle-box-opacity", help="Subtitle background box opacity", type=float, default=0.6)
