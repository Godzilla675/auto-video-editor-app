...
def main() -> None:
    ...
    parser.add_argument("--filter", help="Visual filter to apply (black_white, invert_colors, painting, mirror_x, mirror_y, rotate_90)", default=None)
    parser.add_argument("--intro-text", help="Text for an intro title card", default=None)
    parser.add_argument("--outro-text", help="Text for an outro title card", default=None)
    ...
    parser.add_argument("--box-color", help="Subtitle background box color (e.g. black)", default=None)
    parser.add_argument("--box-opacity", help="Subtitle background box opacity (0.0-1.0)", type=float, default=0.6)
