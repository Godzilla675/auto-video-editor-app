...
def main() -> None:
    ...
    parser.add_argument("--intro-text", help="Text for intro slide", default=None)
    parser.add_argument("--outro-text", help="Text for outro slide", default=None)
    ...
    parser.add_argument("--box-color", help="Background color for subtitles (e.g., 'black', '#000000')", default=None)
